...
public class TelaVoto extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(33, 33, 33)
                        .addComponent(lblR, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        if (i<16){
            lblR.setText("Não Vota! Você tem " + i + " Anos");
        } else {
            if((i>=16 && i<18) || (i>70)) {
                lblR.setText("Voto Opcional!! Você tem " + i + " Anos");
            } else {
                lblR.setText("Voto Obrigatório!! Você tem " + i + " Anos");
            }
        }
